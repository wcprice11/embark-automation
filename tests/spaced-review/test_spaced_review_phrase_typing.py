...
class TestVocabSpacedReviewPhraseTyping(EmbarkRCTest):
    ...
    def test_spaced_review_phrase_typing(self):
        e = self.elements
        ...
        self.markWords("")
        self.click(e.phrase_concept_list_discovered_1)
        ...
        ActionChains(self.driver).move_to_element(textarea).send_keys("Hola.").perform()
        ...
        self.click(e.spaced_review_type_or_say_check)
        self.click(e.typing_mine_works_too)
    ...
    def markWords(self, target):
        ...
        base_label = "Phrase button in vocab list "
        for i in range(6):
